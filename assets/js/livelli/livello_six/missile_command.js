...
var missileCommand = (function() {
  ...
  var startLevel = function() {
    var vect = new Array();
    vect = [200,200,200,200,200];
    frame_per_second = calcola_tempo(vect,5);

    try{
      timerID = setInterval( nextFrame, frame_per_second / 30 );
    }
    catch(err){
      alert("Error!");
    }
