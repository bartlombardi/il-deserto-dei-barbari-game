...
var missileCommand = (function() {
  ...
  function PlayerMissile( source, endX, endY ) {
    ...
    // right direction 
    var scale = (function() {
      fix_five[0] = xDistance;
      fix_five[1] = yDistance;
      var distance = Math.sqrt( calcola_potenza(xDistance, 2) + 
                                calcola_potenza(yDistance, 2) ),
...
function getTest(){
  ...
  if(Math.pow(fix_five[0],2) == calcola_potenza(fix_five[0],2))
    return true;
  else
    return false;
